...
const navItems = [
  {
    ...
    label: 'Home',
    icon: (active: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" fill={active ? 'currentColor' : 'none'} viewBox="0 0 24 24" strokeWidth={active ? 0 : 1.5} stroke={active ? 'none' : 'currentColor'} className="h-5 w-5">
